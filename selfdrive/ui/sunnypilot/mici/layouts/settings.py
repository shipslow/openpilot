...
from openpilot.selfdrive.ui.sunnypilot.mici.layouts.sunnypilot import SunnypilotLayoutMici
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    sunnypilot_panel = SunnypilotLayoutMici()
    sunnypilot_btn = SettingsBigButton(tr("sunnypilot"), "", gui_app.texture("../../sunnypilot/selfdrive/assets/offroad/icon_lateral.png", ICON_SIZE, ICON_SIZE))
    sunnypilot_btn.set_click_callback(lambda: gui_app.push_widget(sunnypilot_panel))
